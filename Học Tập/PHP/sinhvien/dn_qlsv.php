...
echo "Đăng nhập thành công. <a href='trangchu_qlsv.php'.>Trở về trang chủ<a/> ";
die();
}
?>
<!DOCTYPE html>
...
<body>
    <form action="dn_qlsv.php?do=login" method="POST">
        ...
        <a href="khaibaott_sv.php" tile="Đăng ký"> ĐĂNG ký tài khoản</a>
